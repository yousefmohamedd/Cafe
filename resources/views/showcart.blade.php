    ...
    <header class="header-area header-sticky">
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        -->
                            ...
                            <li class="scroll-to-section" style="background-color: skyblue;">
        ...
        <div id="top">
            ...
            <table align="center" bgcolor="yellow">
                ...
                <tr align="center">
                    <th style="padding: 5px;">{{$data->title}}</th>
                    <th style="padding: 5px;">{{$data->price}}</th>
                    <th style="padding: 5px;">{{$data->quantity}}</th>
                </tr>
